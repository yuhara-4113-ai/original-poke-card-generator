...
export const translations = {
  en: {
    ...
    imageZoom: "Zoom",
    directImageAdjustmentHelp: "Drag the image directly in the card preview to reposition it.",
    directImageAdjustmentLabel: "Drag to reposition the card image. Use arrow keys for fine adjustments.",
  ...
  ja: {
    ...
    imageZoom: "拡大・縮小",
    directImageAdjustmentHelp: "カードプレビュー内の画像をドラッグして位置を調整できます。",
    directImageAdjustmentLabel: "ドラッグして画像の位置を調整します。矢印キーでも微調整できます。",
